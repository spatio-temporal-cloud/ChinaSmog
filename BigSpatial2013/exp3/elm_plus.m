function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TVT] = elm_plus(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
